...
const loadDashboard = async (req, res) => {
    try {
        ...
        const filteredRecentProducts = recentProducts.filter(product => product.category);
        const filteredLowStockProducts = lowStockProducts.filter(product => product.category);
